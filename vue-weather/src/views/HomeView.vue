<template>
  <main class="container text-white">
    <div class="pt-4 mb-8 relative">
      <input v-model="searchQuery" type="text" placeholder="Search by city or state" @input="getSearchResults"
      ...
      <ul v-if="mapboxSearchResults" class="absolute bg-weather-secondary text-white w-full shadow-md py-2 px-1 top-[66px]">
        ...
        <p v-if="!searchError && mapboxSearchResults.length === 0">
          No city found, try different term
        </p>
        <template v-else>
...
const mapboxAPIKey = "pk.eyJ1IjoiYXBvdWRlbDEiLCJhIjoiY2xqNmUxeDRhMGk0YTNkbnZhemtrZW85dCJ9.tW0zUy5tAO_gt4aj3VTnxQ";
